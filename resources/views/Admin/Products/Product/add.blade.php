        ...
        <div class="form-group">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <label>pcsBox:</label>
                            <input type="text" name="pcs" placeholder="PCS Box" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">
                            <label>minimum QTY:</label>
                            <input type="text" name="min" placeholder="minimum QTY" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">

                            <label>size:</label>
                            <textarea name="size" class="ckeditor" ></textarea>
                        </div>
