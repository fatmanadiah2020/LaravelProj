                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-yellow">
                        ...
                        <div class="panel-body">
                            ...
                            <label>Name:</label>
                            <input type="text" name="name" value="{{$galleryClass->arName}}" placeholder="Name:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        ...
                        <div class="panel-footer">
                            ...
                            <a href="{{route('galleryClass.index')}}" class="btn btn-primary">Back</a>
                        </div>
                    </div>
                </div>
            </form>
