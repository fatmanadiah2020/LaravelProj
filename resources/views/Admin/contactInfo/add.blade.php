                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <label>Email:</label>
                            <input type="text" name="email" placeholder="Email:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">

                            <label>Company:</label>
                            <input type="text" name="company" placeholder="Company:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">

                            <label>Address:</label>
                            <input type="text" name="address" placeholder="Address:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">

                            <label>City:</label>
                            <input type="text" name="city" placeholder="City:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">

                            <label>Country:</label>
                            <input type="text" name="country" placeholder="Country:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
                        <div class="panel-body">

                            <label>TEl:</label>
                            <input type="text" name="tel" placeholder="tel:" style="border-radius: 5px;width: 100%;height: 32px;">
                        </div>
